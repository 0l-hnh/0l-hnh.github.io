...
주제 : 공기 같은 존재가 되어가는 생성형 AI를 실제 비즈니스에 적용한 사례 소개  
...
- 사례 : 메가존클라우드 Pilot 프로젝트  
  ...
  - 확장 및 production 전략  
    ...
    - Chatbot 프로세스 개선  
    - LLMops 표준화  
- 결론 : 메가존클라우드에서 GenAI360 오퍼링을 지원하며, 위와 같은 시행착오를 통해 언제든 고객에게 맞는 지원이 가능함  
